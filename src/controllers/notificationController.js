...
module.exports = {
  ...
  async list(req, res) {
    try {
      ...
      // If still missing, default to admin role (project configured to deliver notifications to admin role only)
  ...
  // GET /api/notifications/unread_count?recipient_type=role&recipient_id=admin
  async unreadCount(req, res) {
    try {
      ...
      const where = { recipient_type, recipient_id, read: false };
