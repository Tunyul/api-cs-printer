...
CREATE TABLE `order_details` (
  ...
  CONSTRAINT `order_details_ibfk_1647` FOREIGN KEY (`id_order`) REFERENCES `orders` (`id_order`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `order_details_ibfk_1648` FOREIGN KEY (`id_produk`) REFERENCES `products` (`id_produk`) ON UPDATE CASCADE
...
INSERT INTO `orders` VALUES (1,'TRX-24092025-6640-MAUL',33,'2025-09-24 16:40:43','normal',0.00,0.00,'belum_lunas','2025-10-01 16:40:43','','','pending',NULL,NULL,0.00,'pending','','pending');
...
CREATE TABLE `payments` (
  ...
  KEY `no_hp` (`no_hp`),
  CONSTRAINT `payments_ibfk_735` FOREIGN KEY (`no_transaksi`) REFERENCES `orders` (`no_transaksi`) ON UPDATE CASCADE,
  CONSTRAINT `payments_ibfk_736` FOREIGN KEY (`no_hp`) REFERENCES `customers` (`no_hp`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piutang` (
  ...
  KEY `id_customer` (`id_customer`),
  KEY `id_order` (`id_order`),
  CONSTRAINT `piutang_ibfk_339` FOREIGN KEY (`id_customer`) REFERENCES `customers` (`id_customer`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `piutang_ibfk_340` FOREIGN KEY (`id_order`) REFERENCES `orders` (`id_order`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-09-24 23:40:56
