...
CREATE TABLE `payment_allocations` (
  ...
  CONSTRAINT `payment_allocations_ibfk_1` FOREIGN KEY (`id_payment`) REFERENCES `payments` (`id_payment`) ON UPDATE CASCADE,
  CONSTRAINT `payment_allocations_ibfk_2` FOREIGN KEY (`id_piutang`) REFERENCES `piutang` (`id_piutang`) ON UPDATE CASCADE
...
-- Dump completed on 2025-09-28 10:18:18
